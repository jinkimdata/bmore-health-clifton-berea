			...
			switch(toSlide) {
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+darkgreen
								+';">95 percent</span> of the neighborhood\'s residents are <span style="color:'+darkgreen
								+';">black</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+darkgreen
								+';">63 percent</span> ')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+darkgreen
								...
								+darkgreen+';">single-parent households</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+darkgreen
								+';">65 percent</span> ')
				...
				case 3:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('Clifton-Berea has the 8th lowest <span style="color:'+oGrape
								+';">median household income</span> in Baltimore at <span style="color:'+oGrape
								+';">$25,738</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+oGrape
								+';">$47,819</span> ')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
				...
				case 4:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('<span style="color:'+oGrape
								+';">45 percent</span> of residents make <span style="color:'+oGrape
								+';">under $25,000</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+oGrape
				...
				case 5:
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+oGrape
								+';">17 percent</span> of residents 16 or older are <span style="color:'+oGrape
								+';">unemployed</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+oGrape
				...
				case 6:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('The neigborhood consists of <span style="color:'+oTeal
								+';">12 percent green space</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+oTeal
								+';">33 percent</span> ')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
				...
				case 7:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('It has one of the highest rates of <span style="color:'+oTeal
								+';">rat complaints</span> at <span style="color:'+oTeal
				...
				case 8:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('Clifton-Berea has the lowest percentage of third-graders rated <span style="color:'+oIndigo
								+';">"proficient" or better in reading</span> at <span style="color:'+oIndigo
								+';">35 percent</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+oIndigo
								+';">56 percent</span> ')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
				...
				case 9:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('<span style="color:'+oIndigo
								+';">47 percent</span> of neighborhood high school students <span style="color:'+oIndigo
				...
				case 10:
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+oIndigo
								+';">8 percent</span> of neighborhood adults have a <span style="color:'+oIndigo
								+';">bachelor\'s degree or more</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+oIndigo
								+';">29 percent</span> ')
						...
						.each(function(d,i){
							...
							if (i < 21) {
								...
								d3.select(this)
									...
									.duration(150)
									.delay(delay + 20*i)
									.style('width',Math.floor(cubeWidth * 0.6))
									.attr('fill',oRed)
									.attr('transform',
										"translate(" + ((i%10)*cubeWidth) + "," +
										(Math.floor(i/10) * cubeWidth) + ")");
								...
								d3.select(this)
									...
									.duration(150)
									.delay(delay + 20*i)
									.style('width',Math.floor(cubeWidth * 0.4))
									.attr('fill',oPink)
									.attr('transform',
										"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
										((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
								...
								d3.select(this)
									...
									.duration(150)
									.delay(delay + 20*i)
									.style('width',Math.floor(cubeWidth * 0.9))
									.attr('fill',oGrape)
									.attr('transform',
										"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
										((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
								...
								d3.select(this)
									...
									.duration(150)
									.delay(delay + 20*i)
									.style('width',Math.floor(cubeWidth * 0.7))
									.attr('fill',oViolet)
									.attr('transform',
										"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
										((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('Clifton-Berea has the <span style="color:'
								+oGrape+';">fifth highest</span> homicide rate among 55 Baltimore neighborhoods at <span style="color:'
				...
				case 95:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p').remove();
						textWrap.append('p')
							.html('In addition to the public health issues, the neighborhood also has the <span>eighth lowest</span> median household income at <span>$25,738</span>.')
							.attr('class','text__stat');
						textWrap.append('p')
							.html('<span style="color:'+orange
								+';">44.8%</span> of Clifton-Berea households make <span style="color:'
							...
							if (i < 45) {
								...
								if (i == 44) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth * 0.8))
										.attr('fill',orange)
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
											((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
								...
								if (i == 100) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth * 0.2))
										.attr('fill',gray)
										.attr('visibility','visible')
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
				...
				case 96:
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+orange
								+';">17.4%</span> of the area\'s residents 16 or older are <span style="color:'+orange
								+';">unemployed</span>.')
							.attr('class','text__stat');
						$('.text').fadeIn();
					});
				...
				case 97:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p').remove();
						textWrap.append('p')
							.html('Among the neighborhoods 5,776 adults 25 or older, <span style="color:'+darkgreen
								+';">63.3%</span> have a <span style="color:'+darkgreen
								+';">high school diploma</span>.')
							.attr('class','text__stat');
						$('.text').fadeIn();
					});
					newRow = 0;
				...
				case 98:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p').remove();
						textWrap.append('p')
							.html('<span style="color:'+darkgreen+';">7.7%</span> of adults 25 or older have a <span style="color:'
								+darkgreen+';">bachelor\'s degree or more</span>, the third lowest rate in the city.')
							.attr('class','text__stat');
						$('.text').fadeIn();
					});
					newRow = 0;
							...
							if (i < 5) {
								...
								if (i==4) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth * 0.5))
										.attr('fill',darkgreen)
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
											((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
