							...
							if (i < 45) {
								...
								if (i == 44) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth *.8))
										.attr('fill',orange)
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
											((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
								...
								if (i == 100) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth *.2))
										.attr('fill',gray)
										.attr('visibility','visible')
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+darkgreen+';">7.7%</span> of adults 25 or older have a <span style="color:'
								+darkgreen+';">bachelor\'s degree or more</span>.')
							.attr('class','text__stat');
						$('.text').fadeIn();
					});
					newRow = 0;
							...
							if (i < 5) {
								...
								if (i==4) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth *.5))
										.attr('fill',darkgreen)
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
											((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
				...
				case 9:
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							...
							.attr('class','text__stat');
						textWrap.append('p')
							.html('<a href="" target="_blank">Explore more neighborhood data</a>')
							.attr('class','text__stat');
						textWrap.append('p').append('hr');
						textWrap.append('p')
							.html('Visualization by '+'<a href="">Jin Bae Kim</a>')
							.attr('class','text__stat');
						textWrap.append('p')
