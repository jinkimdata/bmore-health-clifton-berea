			...
			switch(toSlide) {
				...
				case 7:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p').remove();
						textWrap.append('p')
							.html('Among 5,776 adults 25 or older, <span style="color:'+darkgreen
				...
				case 8:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p').remove();
						textWrap.append('p')
							.html('Among 5,776 adults 25 or older, 63.3% have a high school diploma.')
							.style('color',gray)
							.attr('class','text__stat');
						textWrap.append('p')
							.html('<span style="color:'+darkgreen+';">7.7%</span> have a <span style="color:'
				...
				case 99:
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+orange
								+';">47.9%</span> of the area is within <span style="color:'+orange
								+';">food deserts</span>, in which fresh produce is difficult to access.')
							.attr('class','text__stat');
						$('.text').fadeIn();
					});
					newRow = 0;
							...
							if (i < 49) {
								...
								if (i == 100) {
									d3.select(this)
										...
										.duration(150)
										.delay(delay + 20*i)
										.style('width',Math.floor(cubeWidth *.1))
										.attr('fill',gray)
										.attr('visibility','visible')
										.attr('transform',
											"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
