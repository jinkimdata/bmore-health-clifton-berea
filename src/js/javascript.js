var bmoreHealthProfile = {
	...
	share: function(){
		$(".icon-twitter-squared").on("click", function(){
			var tweet = "Explore Clifton-Berea in this in-depth data dive."; //Tweet text
			var url = "http://data.baltimoresun.com/news/neighborhood-health/clifton-berea"; //Interactive URL
			var twitter_url = "https://twitter.com/intent/tweet?text="+tweet+"&url="+url+"&tw_p=tweetbutton";
			window.open(twitter_url, 'mywin','left=200,top=200,width=500,height=300,toolbar=1,resizable=0'); return false;
		});
		$(".icon-facebook-squared").on("click", function(){
			var picture = "http://data.baltimoresun.com/news/neighborhood-health/clifton-berea/images/thumb.jpg"; //Picture URL
			var title = "Baltimore Neighborhood Health 2016"; //Post title
			var description = "Explore Clifton-Berea in this in-depth data dive."; //Post description
			var url = "http://data.baltimoresun.com/news/neighborhood-health/clifton-berea"; //Interactive URL
			...
			switch(toSlide) {
					...
					for(var i = 0;i < 110;i++) {
						if (i < 100) {
							cubesSVG.append('rect')
								.attr('fill',gray)
								.attr('width',cubeWidthPadded)
								.attr('height',cubeWidthPadded)
								.attr('class','cube')
								.attr('fill',gray)
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">95 percent</span> of the neighborhood\'s residents are <span style="color:'+accent
								+';">black</span>.')
							.attr('class','text__list');
						textWrap.append('p')
				...
				case 2:
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">83 percent</span> of the neighborhood\'s children live in <span style="color:'
								+accent+';">single-parent households</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">65 percent</span>')
				...
				case 3:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('Clifton-Berea has the 8th lowest <span style="color:'+accent
								+';">median household income</span> in Baltimore at <span style="color:'+accent
								+';">$25,738</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
				...
				case 4:
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">45 percent</span> of residents make <span style="color:'+accent
								+';">under $25,000</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
				...
				case 5:
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">17 percent</span> of residents 16 or older are <span style="color:'+accent
								+';">unemployed</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
				...
				case 6:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('The neigborhood consists of <span style="color:'+accent
								+';">12 percent green space</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">33 percent</span>')
				...
				case 7:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('It has one of the highest rates of <span style="color:'+accent
								+';">rat complaints</span> at <span style="color:'+accent
								+';">978 calls per 10,000 households</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">409 per 10,000 households</span>')
							.attr('class','text__list');
						$('.text').fadeIn();
					});					
				...
				case 8:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('It has the third highest rate of <span style="color:'+accent
								+';">lead paint violations</span> at <span style="color:'+accent
								+';">49 per 10,000 households</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">10 per 10,000 households</span>')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
					iconShape(accent, iconHouse);
				...
				case 9:
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('It also has the second highest density of <span style="color:'+accent
								+';">vacant buildings</span> at <span style="color:'+accent
								+';">2,649 per 10,000 housing units</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">562 per 10,000 housing units</span>')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
					iconShape(accent, iconHouse);
				...
				case 10:
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">48 percent</span> of the neighborhood is covered by a food desert.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">13 percent</span>')
				...
				case 11:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('Clifton-Berea has the lowest percentage of third-graders rated <span style="color:'+accent
								+';">"proficient" or better in reading</span> at <span style="color:'+accent
								+';">35 percent</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
				...
				case 12:
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">47 percent</span> of neighborhood high school students <span style="color:'+accent
								+';">missed 20 or more days of school</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">39 percent</span>')
				...
				case 13:
					...
					$('.text').fadeOut(function(){
						...
						textWrap.append('p')
							.html('<span style="color:'+accent
								+';">8 percent</span> of neighborhood adults have a <span style="color:'+accent
								+';">bachelor\'s degree or more</span>, the fourth lowest rate among neighborhoods.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">29 percent</span>')
				...
				case 14:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p')
							.remove();
						textWrap.append('p')
							.html('Clifton-Berea has the third highest rate of <span style="color:'+accent
								+';">non-fatal shootings</span> at <span style="color:'+accent
								+';">20 shootings per 10,000 residents</span>.')
							.attr('class','text__list');
						textWrap.append('p')
							.html('City overall: <span style="color:'+accent
								+';">7 per 10,000 residents</span>')
							.attr('class','text__list');
						$('.text').fadeIn();
					});
						...
						.each(function(d,i){
							...
							if (i < 21) {
								...
								d3.select(this)
									...
									.duration(150)
									.delay(20*i)
									.attr('width',Math.floor(cubeWidth *.6))
									.attr('fill',oRed)
									.attr('transform',
										"translate(" + ((i%10)*cubeWidth) + "," +
										(Math.floor(i/10) * cubeWidth) + ")");
								...
								d3.select(this)
									...
									.duration(150)
									.delay(20*i)
									.attr('width',Math.floor(cubeWidth *.4))
									.attr('fill',oPink)
									.attr('transform',
										"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
										((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
								...
								d3.select(this)
									...
									.duration(150)
									.delay(20*i)
									.attr('width',Math.floor(cubeWidth *.9))
									.attr('fill',oGrape)
									.attr('transform',
										"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
										((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
								...
								d3.select(this)
									...
									.duration(150)
									.delay(20*i)
									.attr('width',Math.floor(cubeWidth *.7))
									.attr('fill',oViolet)
									.attr('transform',
										"translate(" + (((i+newRow)%10)*cubeWidth) + "," +
										((Math.floor((i+newRow)/10)) * cubeWidth) + ")");
				...
				default:
					...
					$('.text').fadeOut(function(){
						textWrap.selectAll('p').remove();
						textWrap.append('p')
							.html('<a href="" target="_blank">Read more about Clifton-Berea</a>')
							.attr('class','text__stat');
						textWrap.append('p')
							.html('<a href="http://data.baltimoresun.com/news/neighborhood-health/" target="_blank">Explore more neighborhood data</a>')
							.attr('class','text__stat');
						textWrap.append('p').append('hr');
						textWrap.append('p')
							.html('Visualization by Jin Bae Kim, '+'<a href="http://www.baltimoresun.com/data">The Baltimore Sun Data Desk</a>')
							.attr('class','text__stat');
						textWrap.append('p')
							.html('Data from '+'<a href="http://health.baltimorecity.gov/neighborhoods/neighborhood-health-profile-reports">Baltimore City Health Department\’s 2017 Neighborhood Health Profiles</a>')
							.attr('class','text__stat');
						$('.text').fadeIn();
					});
					break;
