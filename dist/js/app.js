        ...
        $(".slideBtn").on("click", function() {
            ...
            switch (toSlide) {
              ...
              case 0:
                ...
                dataLegendSVG.append("rect").style("opacity", 0).style("width", cubeWidth - cubePadding).style("height", cubeWidth - cubePadding).attr("fill", accent).transition();
              ...
              case 18:
                ...
                dataLegendSVG.select("rect").transition().duration(1e3).style("opacity", 1).style("fill", accent).attr("visibility", "visible");
                dataLegendSVG.select("text").transition().duration(1e3).style("opacity", 1);
              ...
              default:
                ...
                cubesSVGRect = cubesSVG.selectAll("rect").each(function(d, i) {
                    if (i < 100) {
                        d3.select(this).attr("stroke", "none").transition().duration(150).delay(delay + 20 * i).style("width", cubeWidth - cubePadding).style("height", cubeWidth - cubePadding).attr("fill", gray).attr("visibility", "visible").attr("transform", "translate(" + i % 10 * cubeWidth + "," + Math.floor(i / 10) * cubeWidth + ")");
                    } else {
            ...
            function iconShape(color, array) {
                ...
                cubesSVG.selectAll("rect").each(function(d, i) {
                    if (array[shapeCounter] == i) {
                        shapeCounter++;
                        d3.select(this).attr("stroke", "none").transition().duration(150).delay(delay + 20 * i).style("width", cubeWidth - cubePadding).style("height", cubeWidth - cubePadding).attr("visibility", "visible").attr("fill", color).attr("stroke", white).attr("transform", "translate(" + i % 10 * cubeWidth + "," + Math.floor(i / 10) * cubeWidth + ")");
                    } else {
